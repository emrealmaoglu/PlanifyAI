...
def create_test_cases() -> List[BenchmarkTestCase]:
    ...
    test_cases.append(
        BenchmarkTestCase(
            ...
            buildings=[
                Building(id="classroom_a", type=BuildingType.CLASSROOM, area=1500, floors=3),
                Building(id="classroom_b", type=BuildingType.CLASSROOM, area=1500, floors=3),
    ...
    test_cases.append(
        BenchmarkTestCase(
            ...
            buildings=[
                ...
                Building(id="classroom", type=BuildingType.CLASSROOM, area=2500, floors=3),
    ...
    test_cases.append(
        BenchmarkTestCase(
            ...
            buildings=[
                ...
                Building(id="engineering", type=BuildingType.LABORATORY, area=3500, floors=4),
                Building(id="sciences", type=BuildingType.LABORATORY, area=3500, floors=4),
                Building(id="classroom_a", type=BuildingType.CLASSROOM, area=2000, floors=3),
                Building(id="classroom_b", type=BuildingType.CLASSROOM, area=2000, floors=3),
    ...
    test_cases.append(
        BenchmarkTestCase(
            ...
            buildings=[
                ...
                Building(id="engineering", type=BuildingType.LABORATORY, area=4000, floors=4),
                Building(id="sciences", type=BuildingType.LABORATORY, area=4000, floors=4),
                ...
                Building(id="classroom_block", type=BuildingType.CLASSROOM, area=3500, floors=4),
    ...
    test_cases.append(
        BenchmarkTestCase(
            ...
            buildings=[
                ...
                Building(id="engineering_lab", type=BuildingType.LABORATORY, area=4500, floors=5),
                Building(id="science_lab", type=BuildingType.LABORATORY, area=4500, floors=5),
                Building(id="medical_lab", type=BuildingType.LABORATORY, area=4000, floors=4),
                ...
                Building(id="lecture_hall_a", type=BuildingType.CLASSROOM, area=3000, floors=4),
                Building(id="lecture_hall_b", type=BuildingType.CLASSROOM, area=3000, floors=4),
                Building(
